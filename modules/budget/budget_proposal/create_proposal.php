...
<?php 
	...
	<?php
		...
		$sql = "SELECT project_id, project_code, name, status FROM projects ORDER BY created_at DESC";
						...
						<div class="grid grid-cols-2 gap-6">
								...
								<div class="mb-6">
										...
										<select id="project" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none">
												...
												<option value="<?php echo htmlspecialchars($project['project_code'] . ' - ' . $project['name']); ?>" data-id="<?php echo $project['project_id']; ?>">
							...
							</div>												<!-- Purchase Fields (hidden by default) -->
