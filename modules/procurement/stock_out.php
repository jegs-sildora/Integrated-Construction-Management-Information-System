...
$has_orders = false;
if ($project_id > 0) {
    // We must query the 'icmis_procurement_inventory_db'. 
    // We assume the variable from 'php/db_connect.php' is $conn (or similar).
    // Safest approach: Direct query with database prefix just in case connections are merged.
