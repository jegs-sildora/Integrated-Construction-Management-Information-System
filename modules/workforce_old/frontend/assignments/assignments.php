<!doctype html>
<html lang="en">
  <?php $pageTitle = "Workforce & Labor - Assignments"; include
  '../components/head.php'; ?>
  ...
  <body>
    <section class="dashboard-container">
      ...
      <main class="main-content" role="main">
        <!-- Top Bar -->
        <?php $title = "Employee Assignments"; $breadcrumbs = [ ['label' =>
        'Labor & Workforce > Assignments', 'link' => null], ['label' => $title, 'link' =>
        null] ]; include '../components/top-bar.php'; ?>

        <!-- ================= CONTENT WRAPPER ================= -->
        <section class="content-wrapper">
          <?php $section = 'assignments'; include '../components/tabs.php'; ?>
    ...
    <?php include 'modal.php'; ?> <?php include '../components/scripts.php'; ?>

    <script>
      $(document).ready(function () {
        const backendUrl = "../../backend/assignments/backend_assignments.php";
        ...
        function loadProjectFilter() {
          $.getJSON(
            "../../backend/projects/backend_projects.php",{ fetch_all: 1 },
            (res) => {
        ...
        function loadAssignments() {
          $.ajax({
            url: `${backendUrl}?fetch_all=1`,
            dataType: "json",
            success: (res) => {
              if (!res.success)
                return showToast("Error fetching assignments", "error");
        ...
        $("#addAssignmentBtn").click(() => {
          ...
          $.getJSON(`${backendUrl}?get_next_id=1`, (res) => {
            if (res.success) $("#assignment_id").val(res.next_id);
          });
        ...
        function loadDropdowns() {
          // Load Employees
          $.getJSON(
            "../../backend/employee/backend_employee.php?fetch_employees",
            (res) => {
              ...
              $("#employeeSelect").html(
                `<option value="">Select Employee</option>${employeeOptions}`,
              );
            },
          );
          ...
          // Load Projects
          $.getJSON(
            "../../backend/projects/backend_projects.php",
            { fetch_all: 1 },
            (res) => {
        ...
        assignmentForm.submit(function (e) {
          ...
          $.post(
            ...
            (res) => {
              ...
              assignmentModal.fadeOut(); // or bulkAssignmentModal.fadeOut();
              loadAssignments();
            },
            "json",
          );
        ...
        $(document).on("click", ".edit-btn", function () {
          $.getJSON(backendUrl, { fetch_id: $(this).data("id") }, (res) => {
            if (!res.success) return;
